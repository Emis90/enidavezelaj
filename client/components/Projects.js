          ...
          <div className='card'>
            <div className='front'>
              ...
              <div className="description">
                ...
                <br />
                <p>Fullstach development where users can log in and experience the real estate hunt for amazing NYC museums.</p>
            ...
            <div className="back">
              ...
              <a href="https://museumsofnyc.herokuapp.com" className='tech-used'>Get your own museum!</a>
              <div>
          ...
          <div className='card'>
            <div className='front'>
              ...
              <div className="description">
                ...
                <br />
                <p>Mobile VR game where the player collects items floating away in space by tapping the screen.</p>
        ...
        <div className='proj' id='cupcakestore'>
          <div className='card'>
            ...
            <div className="back">
              ...
              <div>
                <a href="https://fantasticsweetcupcakes.herokuapp.com" className='tech-used'>Buy some cupcakes!</a>
              </div>
              <div>
                <a href="https://github.com/fantastic-four-grace-shopper/grace-shopper" className='tech-used'>
                  GitHub
                </a>
              </div>
            </div>
