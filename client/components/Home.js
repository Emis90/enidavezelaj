      ...
      <div className='about' >
        ...
        <div id="text">
          ...
          <div className='mystory'>
            <p>I am a New York based Software Developer.
            I attedned Grace Hopper at Fullstack Academy of code, an immersive training program that teaches developers technologies that are in high demand and best practices for implementing them.  I have experience pair programming and developing projects from start to finish.
            I am experienced with Java Script, React, NERD Stack (Node.js, Express, React, Databases).
